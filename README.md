...
<body oncontextmenu="return false" onkeydown="return checkSafe(event)">
...
<div class="container">
    <div id="auth-zone">
        ...
        <label for="q2">😽 我最喜歡跟我一起玩的運動是？</label>
...
<script>
    // SHA-256 加密後的答案，原始碼中絕對看不到 0501 或 籃球
    ...
    function val() {
        const i1 = CryptoJS.SHA256(document.getElementById('q1').value.trim()).toString();
        const i2 = CryptoJS.SHA256(document.getElementById('q2').value.trim()).toString();
